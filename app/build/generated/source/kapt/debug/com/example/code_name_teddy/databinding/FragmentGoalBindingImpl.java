...
public class FragmentGoalBindingImpl extends FragmentGoalBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.goalRecyclerView, 6);
    }
    // views
    @NonNull
    ...
    public FragmentGoalBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }
    private FragmentGoalBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
